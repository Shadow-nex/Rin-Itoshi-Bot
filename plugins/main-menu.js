...
> \`\`\` ꨩ🍄ּֽ֪۪۪〫ࣳׄ ${dia} | ${fecha} | ${hora} *⃟░\`\`\`
  ...
  ꧇ֽ֪. ☕֯֟፝ꫂ꯭♡̸̷̫̫̫̫̫̳🄸🄽🄵🄾 - 🄱🄾🅃ダ̸̸̸̸̸̸̸̸̸̸̸̸̶̶̶̶⃯͢͡⩥ 
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🔥୭ୃּּּּּּּּּּ *ᴍᴏᴅᴏ:* Gratis
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🍃୭ୃּּּּּּּּּּ *ᴏᴡɴᴇʀ:* ${global.creador}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🍉୭ୃּּּּּּּּּּ *ʟɪʙʀᴇʀɪᴀ:* ${libreria}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🍓୭ୃּּּּּּּּּּ *ᴛɪᴘᴏ:* ${(conn.user.jid == global.conn.user.jid ? '🌟 ʙᴏᴛ ᴏғɪᴄɪᴀʟ' : '✨ sᴜʙ ʙᴏᴛ')}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🪴୭ୃּּּּּּּּּּ *ʀᴇɢɪsᴛʀᴀᴅᴏs:* ${totalreg} (${registeredUsers})
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🫟୭ୃּּּּּּּּּּ *ɴᴏ ʀᴇɢɪsᴛʀᴀᴅᴏs:* ${totalreg - registeredUsers}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🍃୭ୃּּּּּּּּּּ *ᴄᴏᴍᴀɴᴅᴏs:* ${totalCommands}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ🌹୭ୃּּּּּּּּּּ *ʀᴜɴᴛɪᴍᴇ:* ${uptime}
  ┇᛭̥̥̥̥̥ ᎒⃟ໍ📚୭ୃּּּּּּּּּּ *ᴠs:* ${vs}
  ╰═⪨
...
${readMore}  
  ═─═─═─═─═─═─═─═─═─═
   ...
   ⚡✯͢🕸️ꨩ〪〭 ɴɪᴠᴇʟ: *${level}*
   🌑✯͢🪬ꨩ〪〭 ᴇxᴘ ᴛᴏᴛᴀʟ: *${exp}*
   👁️‍🗨️✯͢🥀ꨩ〪〭 ʀᴀɴɢᴏ: *${role}*
   🔥✯͢🔮ꨩ〪〭 ᴘʀᴇᴍɪᴜᴍ: *${user.premium ? '✔️' : '🔴'}*
   🍏✯͢🌈ꨩ〪〭 ➨ \`ᴘʀᴏɢʀᴇsᴏ:\` *${user.exp - min} => ${xp}* _(${Math.floor(((user.exp - min) / xp) * 100)}%)_
   🔩✯͢⚙️ꨩ〪〭❒ \`ᴄᴏᴍᴀɴᴅᴏs ᴛᴏᴛᴀʟᴇs:\` *${user.commands || 0}*
   🜲━━━━━━━⬣  
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        ...
        externalAdReply: {
          ...
          body: '',
          thumbnailUrl: 'https://shadow-xyz.vercel.app/img/shadow7.jpg',
          sourceUrl: redes,
          mediaType: 1,
